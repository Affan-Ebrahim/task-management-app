<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" style="max-width: 56rem; margin: 0 auto; padding: 1.5rem 1rem;">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('tasks.store') }}" class="bg-white p-6 rounded shadow-md" style="background: white; padding: 2rem; border-radius: 16px; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);">
            @csrf
